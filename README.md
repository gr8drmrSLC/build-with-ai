...
A personal framework for AI-native project development — and a live demo that shows it in action.

## What's here

- `framework/` — core planning, policy, and infrastructure files for AI-driven projects
- `demo/` — React app (Claude API powered) that walks through the methodology and decomposes project ideas live
